...
public class NaverOAuthLoginService {
  ...
  public String getTokenUrl(String path,String code) throws IOException {
    ...
    UriComponents uriComponents =UriComponentsBuilder
        ...
        if(responseCode!=HttpStatus.OK) {
          throw new IllegalStateException("네이버 서버에서 받아오지 못함.");
        }
        return responseBody;
...
//회원 정보 받기
  public String getNaverUserByToken(OAuthTokenDto token) throws IOException {
