...
public String getKakaoToken(String path, String code) throws NotFoundException {
  ...
  UriComponents uriComponents = UriComponentsBuilder
      ...
      if(responseCode==200) {
        ...
        throw new IllegalStateException("카카오톡 서버에서 받아오지 못함.");
      }
}

// 회원 정보 받기
public KakaoUserInfoResponseDto getKakaoUserByToken(OAuthTokenDto token) throws IOException, NotFoundException {
...
// 토큰 갱신
public String updateTokenUrl(String path,String grant_type,OAuthTokenDto oAuthToken) throws IOException {
...
public String executeKakaoUser(String path, OAuthTokenDto oAuthToken) throws IOException {
